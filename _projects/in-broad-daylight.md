...
section: Game Jams
date: 2018-03-18
play: /media/InBroadDaylight
source:
    name: Github
    url: https://github.com/Dwingeloo2/InBroadDaylight
download:
    - platform: Linux
      url: /media/InBroadDaylight/Build/Linux/InBroadDaylight.tar.gz
    - platform: Windows
      versions:
        x86: /media/InBroadDaylight/Build/Windows_x86/InBroadDaylight.zip
        x86_64: /media/InBroadDaylight/Build/Windows_x86_64/InBroadDaylight.zip
    - platform: MacOSX
      url: /media/InBroadDaylight/Build/MacOSX/InBroadDaylight.zip
---
